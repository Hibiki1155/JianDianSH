<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeiHuiFu.aspx.cs" Inherits="KeHu_WeiHuiFu" %>
                ...
                <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="修改">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "XiuGai.aspx?id="+Eval("id") %>'
