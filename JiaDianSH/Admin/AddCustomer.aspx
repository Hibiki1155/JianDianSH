<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddCustomer.aspx.cs" Inherits="UserManger_AddCustomer" %>
    ...
    <table align="center" bgcolor="#d5d4d4" border="0" cellpadding="0" cellspacing="1"
        ...
        <tr>
            <td align="left" colspan="4" style="width: 90px; height: 28px; background-color: #ffffff">
                客户姓名：</td>
            <td align="left" colspan="1" style="width: 413px; height: 28px; background-color: #ffffff">
        ...
        <tr>
            <td align="left" colspan="4" style="width: 90px; height: 33px; background-color: #ffffff">
                年龄：</td>
            <td align="left" colspan="1" style="width: 413px; height: 33px; background-color: #ffffff">
        ...
        <tr>
            ...
            <td align="left" colspan="3" style="height: 33px; background-color: #ffffff">
                ...
                <asp:TextBox
                    ID="pic" runat="server" CssClass="inputBox" ReadOnly="True" Width="72px"></asp:TextBox><input
        ...
        <tr>
            <td align="left" colspan="4" style="width: 90px; height: 34px; background-color: #ffffff">
                登录账号：</td>
            <td align="left" colspan="1" style="width: 413px; height: 34px; background-color: #ffffff">
                <asp:TextBox ID="TextBox1" runat="server" Width="191px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox1"
                    ErrorMessage="*"></asp:RequiredFieldValidator></td>
            <td align="left" colspan="1" style="width: 115px; height: 34px; background-color: #ffffff">
                登录密码：</td>
            <td align="left" colspan="1" style="width: 354px; height: 34px; background-color: #ffffff">
                <asp:TextBox ID="TextBox2" runat="server" TextMode="Password" Width="191px"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox2" ErrorMessage="*"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
