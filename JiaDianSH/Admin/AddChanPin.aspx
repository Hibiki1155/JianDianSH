<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddChanPin.aspx.cs" Inherits="Admin_AddChanPin" %>
    ...
    <table align="center" bgcolor="#d5d4d4" border="0" cellpadding="0" cellspacing="1"
        ...
        <tr>
            <td align="left" colspan="4" style="width: 102px; height: 27px; background-color: #ffffff">
                产品名称：</td>
            <td align="left" colspan="1" style="width: 853px; height: 27px; background-color: #ffffff">
        ...
        <tr style="color: #000000">
            <td align="left" colspan="4" style="width: 102px; height: 33px; background-color: #ffffff">
                产品分类： &nbsp;</td>
            <td align="left" colspan="1" style="width: 853px; height: 33px; background-color: #ffffff">
        ...
        <tr>
            <td align="left" colspan="4" style="width: 102px; height: 174px; background-color: #ffffff">
                产品备注：</td>
            <td align="left" colspan="1" style="width: 853px; height: 174px; background-color: #ffffff">
