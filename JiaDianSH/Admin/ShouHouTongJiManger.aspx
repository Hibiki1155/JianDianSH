<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShouHouTongJiManger.aspx.cs" Inherits="Admin_ShouHouTongJiManger" %>
    ...
    <table align="center" bgcolor="#d5d4d4" border="0" cellpadding="0" cellspacing="1"
        ...
        <tr>
            <td align="center" colspan="5" style="height: 25px; background-color: #ffffff">
                售后状态：<asp:DropDownList ID="DropDownList1" runat="server">
                    <asp:ListItem>等待分配维修人员</asp:ListItem>
                    <asp:ListItem>已分配维修人员</asp:ListItem>
