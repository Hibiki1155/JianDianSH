                ...
                <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                           ...
                           <asp:TemplateField HeaderText="申请时间">
                            ...
                            <asp:TemplateField HeaderText="售后处理">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ChuLi.aspx?id="+Eval("id") %>'
                                        Text="售后处理"></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="查看">
                             ...
                             <asp:TemplateField HeaderText="查看客户">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%# "ShowCustomers.aspx?id="+Eval("KehuID") %>'
                                        Text="查看客户"></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                        </Columns>
